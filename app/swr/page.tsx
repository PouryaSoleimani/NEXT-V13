...
function SwrPage() {
  ...
  console.info("H1 VALUE", h1Ref.current?.ondragover);

  return (
    <div className='bg-black p-4 rounded-md my-6 w-[90%] mx-auto shadow'>
      <h1
        ref={h1Ref}
        className='w-full px-4 text-start bg-orange-600/50 text-2xl font-bold border-b-4 border-white  py-4 rounded-md'>
        USERS :
      </h1>
