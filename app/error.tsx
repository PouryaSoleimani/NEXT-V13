...
export default function ErrorBoundary({
  ...
  return (
    <div className='w-screen h-screen flex font-bold items-center justify-center'>
      <div className='flex bg-zinc-800 outline-[12px] outline-white/20 flex-col  justify-center items-center gap-3 w-200 h-100 backdrop-blur-2xl rounded-lg border-zinc-800'>
        ...
        <div className="center my-3 w-[90%] bg-black p-2.5 rounded-md">
          <details className='min-sm:text-white w-full  mx-auto text-ellipsis overflow-hidden'>
            <summary className="flex gap-3 font-bold font-sans">
