...
function ReactPdf2Component() {
  ...
  const _total = _.sumBy(
    _Products,
    (item: _SingleProductType) => item.price * 10000
  );
          ...
          <Page
            ...
            <View style={_styles.table}>
              <View style={_styles.row}>
                <Text style={[_styles.cell, _styles.header, { width: "45%" }]}>
                  قیمت
                </Text>
                <Text style={[_styles.cell, _styles.header, { width: "10%" }]}>
                  تعداد
                </Text>
                <Text style={[_styles.cell, _styles.header, { width: "45%" }]}>
                  نام محصول
