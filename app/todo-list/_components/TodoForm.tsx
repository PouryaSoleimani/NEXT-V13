  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="flex items-center justify-center gap-3 w-full">
        <Input placeholder="Add Todo" value={inputValue} onChange={(e) => setInputValue(e.target.value)} className="py-6 rounded-lg w-5/6 outline-none font-bold border-2 border-zinc-900 bg-black text-white" />
