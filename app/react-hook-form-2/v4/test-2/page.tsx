  ...
  items: z
    .array(
      z.object({
        ...
        level: z
          .number()
          .min(1, "Level Must Be > 0")
          .max(5, "Level Can't be > 5"),
      })
    )
...
const Test2Page = () => {
  const { control, register, formState, reset, handleSubmit } =
    useForm<FormTypes>({
      resolver: zodResolver(FORMSCHEMA),
      defaultValues: { items: [{ title: "", level: 1 }] },
    });
  ...
  return (
    <div className='section bg-black border border-neutral-700 '>
      ...
      <form
        ...
        className='p-8  pb-5 flex flex-col gap-y-2 rounded-lg'>
